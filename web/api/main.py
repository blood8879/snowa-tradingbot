...
from web.api.routes import status, positions, watchlist, trades, performance, journal, diary, logs, alerts, realtime_prices, market_control, account_reset, ibd, stock_reports
...
app.include_router(stock_reports.router, prefix="/api")
